...
\begin{figure}
	...
	\caption{Ángulos de incidencia transversal y longitudinal. En la figura, el ángulo $\delta$ representa la elevación solar y $H$ el azimut solar, manteniéndose la correspondencia con las variables $\alpha_s$ y $\delta_s$ empleadas en este documento.}
	\label{fig:aoiangles}
\end{figure}
