...
\begin{itemize}
	...
	\item La capacidad del sistema para referenciarse tras desplazamientos arbitrarios.
\end{itemize}
...
\begin{figure}[t]
	...
	{	
		\includegraphics[width=0.45\linewidth]{figuras/dm1}		
		\label{fig:cm1}
	}
	\subfloat[Home.]
	{	
		\includegraphics[width=0.45\linewidth]{figuras/dm2}	
		\label{fig:cm2}
	}
	
	\subfloat[Desplazamiento vertical.]
	{
		\includegraphics[width=0.45\linewidth]{figuras/dm3}		
		\label{fig:cm3}
	}	
	\subfloat[Desplazamiento horizontal.]
	{
		\includegraphics[width=0.45\linewidth]{figuras/dm4}		
		\label{fig:cm4}	
	}
...
\begin{figure}
	...
	{
		\includegraphics[width=0.45\linewidth]{figuras/dm5}		
		\label{fig:cm6}
	}
...
Las pruebas se llevan a cabo en los tres modos, midiendo con un flexómetro los desplazamientos en los ejes X y Z para distintos comandos de entrada, sin realizar \textit{homing} entre movimientos. Se considera suficiente para la validación de posición medidas con precisión de milímetro, pues un error absoluto menor que esta unidad se considera aceptable para la posterior caracterización. 

Para la correcta validación de la precisión se han seguido las siguientes estrategias:

\begin{itemize}
	\item Para el modo manual se realizan, de manera continuada sin volver a referenciarse en \textit{home}, varios movimientos tanto horizontales como verticales. Estos serán de longitudes desde pocos milímitros a varios centímetros, para comprobar que opera como se espera para todo el rango. Figura~\ref{fig:precman}.
	\item En el modo efemérides se introducen dos pares de ángulos y se comprueba que cada movimiento concuerda con la posición que indica la interfaz de usuario. Figura~\ref{fig:precef}.
	\item  En el modo automático se validará que la primera posición es la que indica la interfaz y se dejará operar cierto tiempo. De esta manera se conoce si el sistema acumula error de pequeños movimientos prolongados en el tiempo. Figura~\ref{fig:precaut}.
\end{itemize}
...
\begin{figure}[t]
	...
	\begin{minipage}{\linewidth}
		\centering
		\subfloat[$X_0 = 10\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmm_referencia_vertical}
		}
		\subfloat[$Z_0 = 85\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmm_referencia_horizontal}
		}
		
		\caption*{Referencias en $X_0\,\mathrm{mm}$ y $Z_0\,\mathrm{mm}$.}
	\end{minipage}
	...
	\begin{minipage}{\linewidth}
		...
		\caption*{\textbf{Caso A:} Movimiento a $X=25\,\mathrm{mm}$ y $Z=25\,\mathrm{mm}$.}
	\end{minipage}
\end{figure}
...
\begin{figure}
	...
	\begin{minipage}{\linewidth}
		...
		\caption*{\textbf{Caso B:} Movimiento a $X=50\,\mathrm{mm}$ y $Z=50\,\mathrm{mm}$.}
	\end{minipage}
	...
	\begin{minipage}{\linewidth}
		...
		\caption*{\textbf{Caso C:} Movimiento a $X=42\,\mathrm{mm}$ y $Z=46\,\mathrm{mm}$.}
	\end{minipage}
...
\begin{figure}
	...
	\begin{minipage}{\linewidth}
	\centering
		\subfloat[$X_4 = 25 - 10 = 50\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmmvd}
		}
		\subfloat[$Z_4 = 85 - 25 = 60\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmmhd}
		}
		
		\caption*{\textbf{Caso D:} Movimiento a $X=15\,\mathrm{mm}$ y $Z=60\,\mathrm{mm}$.}
	\end{minipage}	
	
	% ===== PAREJA 5 =====
	\begin{minipage}{\linewidth}
		\centering
		\subfloat[$X_5 = 27 - 10 = 17\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmmve}
		}
		\subfloat[$Z_5 = 85 - 27 = 58\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmmhe}
		}
		
		\caption*{\textbf{Caso E:} Movimiento a $X=17\,\mathrm{mm}$ y $Z=58\,\mathrm{mm}$.}
	\end{minipage}	
			
	% ===== CAPTION GLOBAL =====
	\caption{Resultados experimentales de la precisión de movimiento del sistema para el modo manual.}
	\label{fig:precman}
\end{figure}
...
\begin{figure}[t]
	...
	\begin{minipage}{\linewidth}
		\centering
		\subfloat[Interfaz]{
			\includesvg[width=0.45\linewidth]{figuras/Caso_a_eph_interface}
		}
		
		\subfloat[$X_1 = 43 - 10 = 33\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmeva}
		}	
		\subfloat[$Z_1 = 85 - 13 = 72\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmeha}
		}
		
		\caption*{\textbf{Caso A}}
	\end{minipage}
\end{figure}
...
\ContinuedFloat
	...
	\begin{minipage}{\linewidth}
		\centering
		\subfloat[Interfaz]{
			\includesvg[width=0.45\linewidth]{figuras/Caso_b_eph_interface}
		}
		
		\subfloat[$X_2 = 46 - 10 = 36\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmevb}
		}
		\subfloat[$Z_2 = 85 - 57 = 28\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmehb}
		}
	...
	% ===== CAPTION GLOBAL =====
	\caption{Resultados experimentales de la precisión de movimiento del sistema en modo efemérides.}
	\label{fig:precef}
\end{figure}
...
\begin{figure}
	...
	\begin{minipage}{\linewidth}
		\centering
		\subfloat[Interfaz]{
			\includesvg[width=0.45\linewidth]{figuras/inicio_precision_auo}
		}
		
		\subfloat[$X_i = 39 - 10 = 29\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmavi}
		}	
		\subfloat[$Z_i = 85 - 31 = 54\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmahi}
		}
...
\begin{figure}
	...
	\begin{minipage}{\linewidth}
		\centering
		\subfloat[Interfaz]{
			\includesvg[width=0.45\linewidth]{figuras/fin_precision_auo}
		}
		
		\subfloat[$X_f = 30 - 10 = 20\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmavf}
		}
		\subfloat[$Z_f = 85 - 41 = 44\,\mathrm{mm}$]{
			\includegraphics[width=0.45\linewidth]{figuras/pmahf}
		}
		
		\caption*{\textbf{Caso B:} Movimiento a $X=50\,\mathrm{mm}$ y $Z=50\,\mathrm{mm}$.}
	\end{minipage}
	
	\caption{Resultados experimentales de la precisión de movimiento del modo automático.}
	\label{fig:precaut}
\end{figure}


Como puede observarse en la colección de figuras, vez eliminados los problemas de implementación ligados al software[~\ref{sec:backlash}], el sistema no muestra error de posición, corroborando el buen posicionamiento del panel móvil durante periodos prolongados de actividad, con cambios de sentido involucrados. 

Tras separar en dos procesadores distintos el movimiento y el servidor Wi-Fi, el mecanismo de movimiento horizontal ha reducido casi completamente el error de desplazamiento que se resultaba del movimiento con el pad unidad a unidad. Sin embargo, el movimiento intermitente de los motores con entradas desde el servidor web sigue propiciando la aparición de holguras que provocan un funcionamiento indeseado del sistema. Estos efectos hacen que la posición Z del panel móvil no se corresponda con la que indica la interfaz, como puede apreciarse en la Figura~\ref{fig:manual_error}.
  
\begin{figure}
	\centering
	\subfloat[Patines desalineados.]{
		\includegraphics[width=0.75\linewidth]{figuras/error_pad_dual}
	}
	
	\subfloat[Interfaz con $Z = 43\,\mathrm{mm}$.]{
		\includesvg[width=0.4\linewidth]{figuras/error_posicion}
	}
	\subfloat[$Z = 85 - 50 = 35\,\mathrm{mm}$.]{
		\includegraphics[width=0.4\linewidth]{figuras/error_cm}
	}	
	\caption{Error en el movimiento con el pad.}
	\label{fig:manual_error}	
\end{figure}  
...
\begin{figure}
	...
	\caption{Comparación modo efemérides y automático}
	\label{fig:ephvsauto}
\end{figure}
