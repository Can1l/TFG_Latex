...
\begin{figure}
	...
	\centering
		\subfloat[$X_4 = 25 - 10 = 50\,\mathrm{mm}$]{
			\includesvg[width=0.45\linewidth]{figuras/pmmvd}
		}
		\subfloat[$Z_4 = 85 - 25 = 60\,\mathrm{mm}$]{
			\includesvg[width=0.45\linewidth]{figuras/pmmhd}
		}
		
		\caption*{\textbf{Caso A:} Movimiento a $X=15\,\mathrm{mm}$ y $Z=60\,\mathrm{mm}$.}
	\end{minipage}	
	...
	\begin{minipage}{\linewidth}
		...
		\subfloat[$X_5 = 27 - 10 = 17\,\mathrm{mm}$]{
			\includesvg[width=0.45\linewidth]{figuras/pmmve}
		}
		\subfloat[$Z_5 = 85 - 27 = 58\,\mathrm{mm}$]{
			\includesvg[width=0.45\linewidth]{figuras/pmmhe}
		}
		
		\caption*{\textbf{Caso B:} Movimiento a $X=17\,\mathrm{mm}$ y $Z=58\,\mathrm{mm}$.}
	\end{minipage}	
